      ...
      <div className="!w-[85%] !mx-auto">
        <div className="!bg-[var(--second-bg)] !p-15 !rounded-[50px] !py-16 !px-6 sm:!px-12">
          <div className="!flex !justify-center !items-center !flex-col">
            ...
            <p className="!opacity-70 !mb-10 !text-[var(--primary-text)] !text-center !text-lg">
              Have Questions? Let’s Build the Future of Online Meetings Together.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="!max-w-3xl !mx-auto">
            ...
            <button
              ...
              className={`!block !transition-all !duration-300 !ease-in-out !mt-[15px] hover:!scale-105 hover:!shadow-lg !rounded-lg !text-sm !w-full sm:!w-auto !px-10 !py-3 !text-center !font-bold !mx-auto ${
                state.succeeded 
                  ? "!bg-green-600 !text-white !cursor-not-allowed"
                  : "bg-[var(--primary-bg)] !text-[var(--second-text)] !cursor-pointer"
              }`}
            >
  {state.succeeded ? "Done" : "Send Message"}
</button>
          </form>
        </div>
      </div>
