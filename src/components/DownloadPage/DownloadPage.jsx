...
export default function BestSelling() {
  return (
    <div className="bg-[var(--second-bg)] !pt-[80px] !pb-[80px] relative overflow-hidden !text-[var(--primary-text)]" >
      <img src={leaf} alt="leaf" className="absolute bottom-0 left-[-50px] !z-10" />
      ...
      <div className="relative !z-20 container flex justify-center items-center gap-5 lg:gap-20 flex-wrap">
        ...
        <div>
          ...
          <img src="src/assets/google-play.jpg" alt="google play" className="w-36 h-auto rounded-lg shadow-md hover:scale-105 transition-transform hover:cursor-pointer" />
          <img src="src/assets/app-store.jpg" alt="app store" className="w-36 h-auto rounded-lg shadow-md hover:scale-105 transition-transform hover:cursor-pointer" />
          </div>
        </div>
      </div>
    </div>
